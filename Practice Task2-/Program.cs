namespace Practice_Task2_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Task 7this: Write a program that displays a menu with three options: "1. Say Hello", "2. Show Current Time-of-day", and "3. Exit". The program should prompt the user to enter their choice and perform the corresponding action. If the user enters an invalid choice, the program should throw an exception and display an error message.
            int choice = 0;
            while (true)
            {
